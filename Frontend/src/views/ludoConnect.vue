<template>
    <div class="form-container">
      ...
      <form @submit.prevent="submitForm">
        <div v-if="!isLogin">
          <label for="pseudo" class="texte">Nom de la ludothèque:</label>
  ...
  export default {
    ...
    methods: {
      ...
      submitForm() {
        const url = this.isLogin ? 'http://localhost:3000/ludotheque/Login' : 'http://localhost:3000/ludotheque/Create';
        fetch(url, {
          method: 'POST',
          credentials: 'include',
          headers: {
